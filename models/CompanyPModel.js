...
module.exports = {
    getAllCompanyMaster: () => {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                const sql = "SELECT * FROM pcompany_master order by id desc";
    ...
    getById: (id) => {
        return new Promise(async (resolve, reject) => {
            try {
                // data fetch from company table
                const sql = "SELECT * FROM pcompany_master where id='" + id + "' ";
    ...
    addCompanyMaster: async (params) => {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                const sql = "INSERT into pcompany_master(" + keys.join(",") + ") values ('" + values.join("','") + "') ";
                ...
                let sqlUpdate = "UPDATE pcompany_master SET company_id='" + branch_id + "' where id='" + insertId + "' ";
    ...
    updateCompanyMaster: (id, params) => {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                let sql = "UPDATE pcompany_master SET " + param.join(",") + " where id='" + id + "' ";
    ...
    deleteCompanyMaster: (id) => {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                const sql = "DELETE from pcompany_master WHERE id='" + id + "' ";
